...
![Open MPI implementation in Loma](OpenMPI_Compiler/plots/architecture.png)
...
The project is organized within the directory `OpenMPI_Compiler`, which includes the following components:
